...
<body class="antialiased">
    ...
    <div class="flex min-h-screen" x-data="{ sidebarOpen: false }">
        ...
        <aside class="sidebar w-64 flex flex-col py-6 px-4 fixed h-full z-40
            ...
            <div class="mb-8 px-2">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-600 to-blue-400 flex items-center justify-center font-bold text-sm text-white shadow-md">
                        WA
                    </div>
                    <div>
            ...
            <div class="mt-auto pt-4 border-t border-slate-100">
                <div class="flex items-center gap-3 px-2">
                    <div class="w-8 h-8 rounded-lg flex items-center justify-center text-xs font-bold shrink-0 text-white
                        {{ auth()->user()->isSuperAdmin() ? 'bg-gradient-to-br from-purple-600 to-purple-400' : (auth()->user()->isAuditor() ? 'bg-gradient-to-br from-blue-600 to-blue-400' : 'bg-gradient-to-br from-red-600 to-red-400') }}">
        ...
        {{-- Mobile Header --}}
        <div class="lg:hidden fixed top-0 left-0 right-0 z-30 bg-white border-b border-slate-100 py-3 px-4 flex items-center justify-between shadow-sm">
            <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-2">
                    <div class="w-7 h-7 rounded-lg bg-gradient-to-br from-blue-600 to-blue-400 flex items-center justify-center font-bold text-xs text-white">WA</div>
        ...
        <main class="flex-1 lg:ml-64">
            <div class="p-4 sm:p-6 lg:p-8 max-lg:pt-20">
                {{-- Flash Messages --}}
                @if(session('success'))
                <div class="mb-4 sm:mb-6 bg-emerald-50 border border-emerald-200 rounded-xl p-3 sm:p-4 border-l-4 border-l-emerald-500 flex items-center gap-3">
                ...
                @if(session('error'))
                <div class="mb-4 sm:mb-6 bg-red-50 border border-red-200 rounded-xl p-3 sm:p-4 border-l-4 border-l-red-500 flex items-center gap-3">
