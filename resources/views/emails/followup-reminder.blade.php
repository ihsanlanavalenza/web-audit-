...
<head>
    ...
    <style>
        ...
        .logo { display: inline-flex; align-items: center; justify-content: center; width: 48px; height: 48px; border-radius: 12px; background: linear-gradient(135deg, #2563eb, #60a5fa); color: white; font-weight: bold; font-size: 16px; margin-bottom: 12px; }
        h1 { color: #1e293b; font-size: 20px; margin: 0 0 8px; }
        .subtitle { color: #64748b; font-size: 14px; margin: 0; }
        .alert { background: #fef2f2; border-left: 4px solid #ef4444; border-radius: 8px; padding: 16px; margin: 20px 0; }
        .alert-title { color: #dc2626; font-weight: 600; font-size: 14px; margin: 0 0 4px; }
        .alert-text { color: #7f1d1d; font-size: 13px; margin: 0; }
        ...
        .detail-value { color: #1e293b; font-size: 13px; font-weight: 600; text-align: right; }
    ...
    <div class="container">
        <div class="card">
            ...
            <p style="color: #475569; font-size: 14px; line-height: 1.6;">
                Mohon segera login ke sistem WebAudit dan upload dokumen yang diperlukan melalui halaman <strong>Client Assistance Schedule</strong>.
            </p>
