...
<body style="font-family: Arial, sans-serif; color: #1f2937; line-height: 1.5;">
    ...
    <p>
        <a href="{{ route('register', ['token' => $invitation->token]) }}" style="display: inline-block; background: #2563eb; color: #fff; text-decoration: none; padding: 10px 16px; border-radius: 6px;">
            Buka Undangan
        </a>
    </p>
