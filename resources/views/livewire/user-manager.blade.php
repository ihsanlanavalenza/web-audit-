                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center gap-2">
                                ...
                                <span class="font-medium truncate max-w-[150px] text-slate-900">{{ $user->name }}</span>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="flex gap-2">
                                <button wire:click="editUser({{ $user->id }})" class="text-blue-600 hover:text-blue-700 text-xs font-medium">Edit</button>
                                @if($user->id !== auth()->id())
                                <button wire:click="deleteUser({{ $user->id }})" wire:confirm="Yakin hapus user {{ $user->name }}?" class="text-red-600 hover:text-red-700 text-xs font-medium">Hapus</button>
                                @endif
                            </div>
                        </td>
                    </tr>
