<div>
    ...
    <div class="glass-card p-4 sm:p-6 mb-8">
        <h3 class="text-sm font-semibold text-slate-600 mb-4 uppercase tracking-wider">Status Overview — Semua Request</h3>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div class="glass-card p-4 sm:p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('admin.users') }}" class="text-xs text-blue-600 hover:text-blue-700 font-medium">Lihat Semua →</a>
            </div>
            <div class="space-y-3">
                @forelse($recentUsers as $user)
                <div class="flex items-center gap-3 p-3 rounded-xl bg-slate-50 border border-slate-100">
                    <div class="w-8 h-8 rounded-lg flex items-center justify-center text-xs font-bold shrink-0 text-white
                        {{ $user->role === 'super_admin' ? 'bg-gradient-to-br from-purple-600 to-purple-400' : ($user->role === 'auditor' ? 'bg-gradient-to-br from-blue-600 to-blue-400' : 'bg-gradient-to-br from-red-600 to-red-400') }}">
        ...
        <div class="glass-card p-4 sm:p-6">
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-center gap-3 p-3 rounded-xl bg-slate-50 border border-slate-100">
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-medium truncate text-slate-900">{{ $req->description ?? $req->account_process ?? 'No. ' . $req->no }}</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="p-4 rounded-xl bg-purple-50 border border-purple-100">
                <div class="flex items-center gap-2 mb-3">
                    <div class="w-7 h-7 rounded-lg bg-purple-100 flex items-center justify-center text-purple-700 text-sm">🛡️</div>
            ...
            <div class="p-4 rounded-xl bg-blue-50 border border-blue-100">
                <div class="flex items-center gap-2 mb-3">
                    <div class="w-7 h-7 rounded-lg bg-blue-100 flex items-center justify-center text-blue-700 text-sm">🔵</div>
            ...
            <div class="p-4 rounded-xl bg-red-50 border border-red-100">
                <div class="flex items-center gap-2 mb-3">
                    <div class="w-7 h-7 rounded-lg bg-red-100 flex items-center justify-center text-red-700 text-sm">🔴</div>
